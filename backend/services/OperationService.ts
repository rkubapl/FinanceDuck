...
// const { OperationController: OperationService } = require( '../controllers/OperationController' );
...
async function add(date: Date, name: String, categoryId: Types.ObjectId, type: String, sum: Number) {
...
//     }
//
//     async add(date: Date, name: String, categoryId: Types.ObjectId, type: String, sum: Number) {
//         return await Operation.create({
//             date,
//             name,
//             categoryId,
...
//     // }
//
// //     static async add(date: Date, name, objectId: module: mongoose.Types.ObjectId
// //
// // ,
// //     enumKeyByEnumValue: string
// // ,
// //     sum
// // ) {
// //
